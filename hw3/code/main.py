...
image_kp_path = "../images/output/kp_{}.png"
...
def stitch_the_images():
    ...
    # kp images
    for idx, image in enumerate(progress_list[0]):
        cv2.imwrite(image_kp_path.format(idx), image)

    # match images
    for idx, image in enumerate(progress_list[1]):
...
def stitch_the_abnormal():
    ...
    result = hw3.panorama(image_list)[0]
